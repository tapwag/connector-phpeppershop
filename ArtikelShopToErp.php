...
if ($shopdb->db->connected_database_name == $SHOPdbname) {
     $shop = new pepper($shopdb,$err,$SHOPdbname,$divStd,$divVerm,$minder,$nachn,$versandS,$versandV,$paypal,$treuhand,$mwstLX,$mwstPGLX,$pricegroup,$mwstS,$variantnr,false,false,false,false,$codeLX,$codeS);
} else {
