...
<? pg($pricegroup,$dbP); ?>
        ...
        <input type="radio" name="mwstPGLX" value="1" <?= ($mwstPGLX==1)?"checked":'' ?>> incl.
        <input type="radio" name="mwstPGLX" value="0" <?= ($mwstPGLX<>1)?"checked":'' ?>> excl. MwSt
...
<tr>
    ...
    <td><input type="radio" name="GetAllVariant"  value="1" <?= ($GetAllVariant<>2)?"checked":'' ?>>Ja
    <input type="radio" name="GetAllVariant"  value="2" <?= ($GetAllVariant==2)?"checked":'' ?>>Nein</td>
</tr>
<tr>
